...
"%":"DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedNumberList|WebGLBuffer|WebGLProgram|WebGLShader"},
kn:{
"^":"bool/Gv;",
...
i1:{
"^":"mW;UI,T6",
gA:function(a){var z=this.UI
z=new H.MH(null,z.gA(z),this.T6)
z.$builtinTypeInfo=this.$builtinTypeInfo
return z},
gB:function(a){var z=this.UI
return z.gB(z)},
...
U5:{
"^":"mW;UI,T6",
gA:function(a){var z=new H.SO(J.GP(this.UI),this.T6)
z.$builtinTypeInfo=this.$builtinTypeInfo
return z}},
SO:{
"^":"An;OI,T6",
...
QF:{
"^":"KV;",
gDk:function(a){return H.VM(new W.RO(a,C.kI.Ph,!1),[null])},
...
f2:function(a,b){return a.translate.call$1(b)},
...
return}throw "Unable to print message: " + String(a)}}],["house","file:///C:/Users/qxie/git/building-diagnostics/web/house.dart",,R,{
"^":"",
QL:[function(){var z,y
z=new R.aI(new Float32Array(16))
z.c0()
$.fy=z
z=J.OG($.z0()).t(0,0)
$.qN=z
...
$.Wy=z
J.Np(z,0.2,0.8,1,1)
z=R.ha("            precision mediump float;\n\n            void main(void) {\n                gl_FragColor = vec4(1.0, 1.0, 1.0, 1.0);\n            }\n          ","            attribute vec3 aVertexPosition;\n\n            uniform mat4 uMVMatrix;\n            uniform mat4 uPMatrix;\n\n            void main(void) {\n                gl_Position = uPMatrix * uMVMatrix * vec4(aVertexPosition, 1.0);\n            }\n          ",["aVertexPosition"],["uMVMatrix","uPMatrix"])
$.MU=z
J.jO($.Wy,z.MU)
y=J.Rw($.Wy)
J.wY($.Wy,34962,y)
J.Fe($.Wy,34962,new Float32Array(H.XF([0,1,0,-1,-1,0,1,-1,0])),35044)
J.iw($.Wy,4,0,3)
z=J.TQ($.qN)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(R.xN()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.GW($.a2())
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(R.dq()),z.Sg),[H.Kp(z,0)]).Zz()},"call$0","HA",0,0,0],
v8:[function(a){J.Kr(a)
J.oH($.SL().style,"block")
J.oH($.a2().style,"block")
switch(1){case 0:J.Up($.Ti())
break
case 1:J.Up($.um())
break
default:}a.stopPropagation()},"call$1","xN",2,0,5],
...
J.aS($.Wy,2929)
J.c2($.Wy,3042)
z=Math.tan(0.39269908169872414)*0.1
y=z*1
x=-y
w=-z
...
u=y-x
t=z-w
if(0>=16)return H.e(v,0)
v[0]=0.2/u
if(5>=16)return H.e(v,5)
v[5]=0.2/t
if(8>=16)return H.e(v,8)
v[8]=(y+x)/u
if(9>=16)return H.e(v,9)
v[9]=(z+w)/t
if(10>=16)return H.e(v,10)
v[10]=-1.002002002002002
if(11>=16)return H.e(v,11)
v[11]=-1
if(14>=16)return H.e(v,14)
v[14]=-0.20020020020020018
$.OO=new R.aI(v)
$.PD().push(new R.aI(new Float32Array(H.XF($.fy.grH()))))
J.CR($.fy,[-1.5,0,-7])
J.wY($.Wy,34962,$.kB)
J.GB($.Wy,$.MU.Qg.t(0,"aVertexPosition"),3,5126,!1,0,0)
J.pL($.Wy,$.MU.V0.t(0,"uPMatrix"),!1,$.OO.rH)
J.pL($.Wy,$.MU.V0.t(0,"uMVMatrix"),!1,$.fy.grH())
J.iw($.Wy,4,0,3)
J.CR($.fy,[3,0,0])
v=$.PD()
if(0>=v.length)return H.e(v,0)
$.fy=v.pop()},"call$1","dq",2,0,5],
b5:{
"^":"a;Qg,V0,MU,OQ,AK",
Q3:function(a,b,c,d){var z,y,x,w,v
z=J.lA($.Wy,35632)
this.OQ=z
J.Rb($.Wy,z,a)
J.Ef($.Wy,this.OQ)
...
J.au($.Wy,this.MU)
if(J.U3($.Wy,this.MU,35714)!==!0)P.JS("Could not initialise shaders")
for(z=new H.a7(c,1,0,null),y=this.Qg;z.G();){x=z.lo
w=J.E4($.Wy,this.MU,x)
J.Oo($.Wy,w)
y.u(0,x,w)}for(z=new H.a7(d,2,0,null),y=this.V0;z.G();){v=z.lo
y.u(0,v,J.w0($.Wy,this.MU,v))}},
static:{ha:function(a,b,c,d){var z=new R.b5(P.L5(null,null,null,J.O,J.im),P.L5(null,null,null,J.O,P.SI),null,null,null)
z.Q3(a,b,c,d)
return z}}},
aI:{
"^":"a;rH<",
...
x=[]
for(w=this.rH,v=w.length,u=0;u<4;++u){t=[]
for(s=0;s<4;++s){r=u+s*4
if(r>=v)return H.e(w,r)
z=w[r]
if(Math.abs(z)<1e-16)z=0
y=null
try{y=J.Wi(z,4)}catch(q){H.Ru(q)
y=J.AG(z)}t.push(y)}x.push("| "+C.Nm.zV(t,", ")+" |")}return"Matrix4:\n"+C.Nm.zV(x,"\n")},
c0:function(){var z,y,x
for(z=this.rH,y=z.length,x=0;x<16;++x){if(x>=y)return H.e(z,x)
...
if(4>=u)return H.e(z,4)
s=z[4]
if(typeof x!=="number")return H.s(x)
if(8>=u)return H.e(z,8)
r=z[8]
if(typeof w!=="number")return H.s(w)
if(12>=u)return H.e(z,12)
q=z[12]
...
r=z[5]
s=z[9]
if(13>=u)return H.e(z,13)
z[13]=q*y+r*x+s*w+z[13]*v
s=z[2]
r=z[6]
q=z[10]
if(14>=u)return H.e(z,14)
z[14]=s*y+r*x+q*w+z[14]*v
q=z[3]
r=z[7]
s=z[11]
if(15>=u)return H.e(z,15)
z[15]=q*y+r*x+s*w+z[15]*v
return this},
static:{"^":"Qd"}}},1],["html_common","dart:html_common",,P,{
"^":"",
ed:function(a){var z={}
a.aN(0,new P.zW(z))
return z},
...
J.CR=function(a,b){return J.RE(a).f2(a,b)}
...
I.$lazy($,"container","Tk","z0",function(){return document.querySelector("#container")})
...
I.$lazy($,"mvStack","E2","PD",function(){return H.VM([],[R.aI])})

init.functionAliases={}
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"bB",void:true,args:[W.Aj]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"Za",args:[J.O,null]},];$=null
...
;(function (callback) {
  ...
  if (typeof dartMainRunner === "function") {
    dartMainRunner(function() { H.Rq(R.HA()); });
  } else {
    H.Rq(R.HA());
  }
})
...
if($desc instanceof Array)$desc=$desc[1]
VX.prototype=$desc
function a7(UI,SW,G7,lo){this.UI=UI
this.SW=SW
this.G7=G7
...
if($desc instanceof Array)$desc=$desc[1]
rq.prototype=$desc
function RW(c,b,f,vO){this.c=c
this.b=b
this.f=f
this.vO=vO}RW.builtin$cls="RW"
if(!"name" in RW)RW.name="RW"
$desc=$collectedClasses.RW
if($desc instanceof Array)$desc=$desc[1]
RW.prototype=$desc
function lF(c,b,bK,Gq,Rm){this.c=c
this.b=b
this.bK=bK
this.Gq=Gq
this.Rm=Rm}lF.builtin$cls="lF"
...
if($desc instanceof Array)$desc=$desc[1]
Jb.prototype=$desc
function M4(vO){this.vO=vO}M4.builtin$cls="M4"
...
if($desc instanceof Array)$desc=$desc[1]
Ip.prototype=$desc
function b5(Qg,V0,MU,OQ,AK){this.Qg=Qg
this.V0=V0
this.MU=MU
this.OQ=OQ
this.AK=AK}b5.builtin$cls="b5"
if(!"name" in b5)b5.name="b5"
$desc=$collectedClasses.b5
if($desc instanceof Array)$desc=$desc[1]
b5.prototype=$desc
function aI(rH){this.rH=rH}aI.builtin$cls="aI"
if(!"name" in aI)aI.name="aI"
$desc=$collectedClasses.aI
if($desc instanceof Array)$desc=$desc[1]
aI.prototype=$desc
aI.prototype.grH=function(){return this.rH}
...
if($desc instanceof Array)$desc=$desc[1]
Zf.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,n6,Ny,Y5,Gc,nx,QQ,fW,y4,d7,Um,oJ,He,mN,vH,xO,Em,NW,rV,K4,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,hq,WS,r0,yp,Eh,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,nV,GK,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,PY,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,SG,CG,UN,MT,Rk,Eo,YS,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,p0,Sl,V3,Jo,iO,SI,Qm,ET,zU,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,U5,SO,SU,Ca,vs,da,xw,dm,rq,RW,lF,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,ui,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,BV,id,VG,zL,ec,e7,dx,kE,hm,x5,Fk,RO,eu,xC,Pb,W9,IU,b0,Dg,Ob,GV,Pg,fj,Ip,b5,aI,zW,D7,Zf]}