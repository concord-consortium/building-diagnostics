...
function init() {
	...
	container.addEventListener('dblclick', onMouseDoubleClickCanvas, false);
	overlay.addEventListener('click', onMouseDownOverlay, false);
...
function onMouseDoubleClickCanvas(e) {
	e.preventDefault();
